...
import { logger, supabase, supabaseUrl, supabaseAnonKey , isDev } from '@/utils';
...
export function UserProvider({ children }: any) {
  ...
  const invokeOpenSettings = useRef<unknown | null>({});
  ...
  window.electronAPI.handleOpenUrl(async (_event: unknown, value: string) => {
